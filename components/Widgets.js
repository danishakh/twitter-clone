    ...
    <div className="ml-8 hidden space-y-5 py-1 lg:inline xl:w-[450px]">
      <div className="sticky top-0 z-50 w-11/12 bg-black py-1.5 xl:w-9/12">
        <div className="relative flex items-center rounded-full bg-[#202327] p-3">
          ...
          <input
            type="text"
            className="focus:background-black absolute inset-0 z-50 w-full rounded-full border border-transparent bg-transparent pl-11 text-[#d9d9d9] placeholder-gray-500 outline-none focus:border-[#1d9bf0] focus:shadow-lg"
      ...
      <div className="w-11/12 space-y-3 rounded-xl bg-[#15181c] pt-2 text-[#d9d9d9] xl:w-9/12">
        ...
        {followResults.map((result, index) => (
          <div
            key={index}
            className="flex cursor-pointer items-center px-4 py-3 transition duration-200 ease-out hover:bg-white hover:bg-opacity-[0.03]"
          >
            <Image
              src={result.userImg}
              width={50}
